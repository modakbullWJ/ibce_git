...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL;?>/jquery.mmenu.all.css">
<!--[if lte IE 8]>
...
<!-- 배너 슬라이드를 위한 js링크 2016.07.19 전우찬 -->
<script src="<?php echo G5_JS_URL ?>/jquery.bannerSlider-1.0.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery.banner.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery.DB_rotateRollingBanner.min.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery.twbsPagination.js"></script>
<!-- 모바일 좌측 메뉴 js -->
