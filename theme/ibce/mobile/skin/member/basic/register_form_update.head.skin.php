...
$mb_serial_number = get_serial_mix(16, 4, '-');


// $sql = " select mb_1 from {$g5['member_table']}";
...
// 국가코드를 적용하기 위해 전화번호와 핸드폰번호 변수 받는 방법 변경 register_form.skin.php에서 넘어옴
 $tel_number = sprintf("(%s)%s", $_POST['tel_ccode'], $_POST['mb_tel']);
 $hp_number = sprintf("(%s)%s", $_POST['hp_ccode'], $_POST['mb_hp']);
// $tel_number = sprintf("%s-%s-%s-%s", $_POST['tel_ccode'], $_POST['mb_tel1'],$_POST['mb_tel2'],$_POST['mb_tel3']);
// $hp_number = sprintf("%s-%s-%s-%s", $_POST['hp_ccode'], $_POST['mb_hp1'], $_POST['mb_hp2'], $_POST['mb_hp3']);
//  -- 2016.07.21 전우찬

// $gr_number = sprintf("%s-%s-%s-%s", $_POST['gr_ccode'], $_POST['gr_tel1'], $_POST['gr_tel2'], $_POST['gr_tel3']);
$gr_number = sprintf("(%s)%s", $_POST['gr_ccode'], $_POST['gr_tel']);
