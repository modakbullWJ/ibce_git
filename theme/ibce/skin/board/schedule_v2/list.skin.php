   ...
   <td width="60%" align="center" style="margin-bottom:20px; height:50px;">
    <table border="0" cellspacing="5" cellpadding="0">
      <tr>
       ...
       <td style="padding:0 10px;font-size:18px;font-weight:bold;"><a href="<?php echo $_SERVER[PHP_SELF]."?bo_table=".$bo_table; ?>" title="오늘로" onfocus="this.blur()" style="font-size:24px; color:#ba9765;"><? echo ("$year".년."&nbsp;$month".월); ?></a></td>
