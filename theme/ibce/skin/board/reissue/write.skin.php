        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_subject" value="재발급 신청합니다. / 申请. <?php //echo $subject ?>" id="wr_subject" required class="frm_input required" size="50" maxlength="255">
...
<tr>
    ...
    <td>
        <input type="text" id="wr_6" name="wr_6" value="<?php echo $member['mb_9'] ?>" class ="frm_input required" required>
    </td>
    ...
    <!--   <select name='wr_4_1' id='wr_4_1' itemname='취득년도(Acquisition Year)' required class="frm_input required">
        ...
        <select name="wr_5_1" id='wr_5_1' itemname='취득년도(Acquisition Year)' required class="frm_input required">
            <option value='' >선택</option>
            <?
           // for ($i = 1; $i < 13; $i++) {
              //  if ($i < 10) {$k = "0" . $i;
          ...
          //  }
            ...
            <select name="wr_6_1" id="wr_6_1" itemname='취득년도(Acquisition Year)' required class="frm_input">
            <option value='' >선택</option>
            <?
           // for ($i = 1; $i < 32; $i++) {
          //      if ($i < 10) {$k = "0" . $i;
...
<tr>
  ...
  <input type="hidden" id="wr_8" name="wr_8" value="<?php echo $member['mb_1'] ?>">



<!--      <select name='wr_7' id='wr_7' itemname='신청일자(Application Date)' required class="frm_input required">
            <option value='' >선택</option>
            <?
            //for ($i = 1990; $i < 2016; $i++) {
              //  echo "<option value='$i' <? if($write[$i] == '$i') echo ' selected '; ?>$i</option>";
        ...
        <select name="wr_8" id='wr_8' itemname='신청날짜(Application Date)' required class="frm_input required">
            <option value='' >선택</option>
            <?
           // for ($i = 1; $i < 13; $i++) {
            //    if ($i < 10) {$k = "0" . $i;
          ...
          //  }
            ...
            <select name="wr_9" id="wr_9" itemname='신청날짜(Application Date)' required class="frm_input">
            <option value='' >선택</option>
            <?
         //   for ($i = 1; $i < 32; $i++) {
          //      if ($i < 10) {$k = "0" . $i;
