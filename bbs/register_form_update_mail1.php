...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <p style="margin:20px 0 0;padding:30px 30px 50px;min-height:200px;height:auto !important;height:200px;border-bottom:1px solid #eee">
            <b><?php echo $mb_name ?></b> 님의 회원가입을 진심으로 축하합니다. <br> 恭喜<?php echo $mb_name ?></b>的成员.<br>
            회원님의 성원에 보답하고자 더욱 더 열심히 하겠습니다.<br>
            <?php if ($config['cf_use_email_certify']) { ?>아래의 <strong>메일인증</strong>을 클릭하시면 회원가입이 완료됩니다.<br> 点击下边的<strong>电子邮件认证</strong>注册就完成了。<?php } ?>
            <br>감사합니다. / 谢谢您。
        </p>

        <?php if ($config['cf_use_email_certify']) { ?>
        <a href="<?php echo $certify_href ?>" target="_blank" style="display:block;padding:30px 0;background:#484848;color:#fff;text-decoration:none;text-align:center">메일인증 / 电子邮件认证</a>
        <?php } else { ?>
