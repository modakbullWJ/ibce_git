...
if (G5_IS_MOBILE) {
    ...
    include_once(G5_THEME_MOBILE_PATH.'/skin/member/basic/register_form_update.head.skin.php');
...
$mb_tel         = trim($tel_number);
$mb_hp          = trim($hp_number);
...
//  본인확인
//---------------------------------------------------------------
// 핸드폰넘버 본인확인을 위한 하이픈 함수 주석처리 2016-07-26 전우찬
